...
export { default as CourseShow } from "./Main/CourseShow";
export { default as MainMenu } from "./Main/MainMenu";
export { default as Banner } from "./Main/Banner";
export { default as LastCourses } from "./Main/LastCourses";
export { default as Course } from "./Main/CourseShow";
export { default as SuggestedCourses } from "./Main/SuggestedCourses";
export { default as SuggestedCourse } from "./Main/SuggestedCourse";
